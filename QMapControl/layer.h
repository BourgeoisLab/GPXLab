...
namespace qmapcontrol
{
    ...
    public:
        ...
        /*!
         * This method returns a list of all Geometry objects from this Layer.
        ...
        //! consumes the mouse event.
        /*!
         * This will stop emitting the signal geometryClicked() 
         * for the current mouse event.
         */
    ...
    signals:
         ...
         * Use consumeMouseEvent() to stop emitting the signal for the current mouse click.
