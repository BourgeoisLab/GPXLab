...
namespace qmapcontrol
{
    ...
    public:
        ...
        enum MouseMode
        {
            ...
            PanningNoZoom, /*!< The map is moved but not zoomed on mouse click */
            Dragging, /*!< A rectangular can be drawn */
            DraggingNoZoom, /*!< A rectangular can be drawn but not zoomed on mouse click */
         ...
         * @param suspend enable/disable suspending
         */
        void suspendUpdate(bool suspend);

        //! checks if updates are suspended
        /*!
